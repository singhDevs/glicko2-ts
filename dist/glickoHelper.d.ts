...
declare function calculateGValue(phi: number): number;
...
export { adjustRDForTime, calculateGValue, expectedScore, variance, delta, updateVolatility, getPreUpdateRD, getNewRD, getNewRating };
